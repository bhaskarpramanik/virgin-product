...
/**
 * Description of AnimusMaintRedirect
 * Case of 503 status code
 * @author bhaskarpramanik
 */
require_once "AnimusTemporaryRedirect.php";
class AnimusMaintRedirect extends AnimusTemporaryRedirect{
    ...
    public function stackHTTPHeaders($flag = true) {
        $this->log("Entering method ".__METHOD__.". Input params = none");
        parent::stackHTTPHeaders($this->_redirectLocationFlag);
        $this->log("Exiting method ".__METHOD__);
    }
    
    public function setRedirectLocationFlag(){
        $this->log("Entering method ".__METHOD__.". Input params = none");
        $this->_redirectLocationFlag = REDIRECT_503;
        $this->log("Exiting method ".__METHOD__);
    }
